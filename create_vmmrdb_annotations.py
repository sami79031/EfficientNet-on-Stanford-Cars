#!/usr/bin/env python3
"""
Create annotations for VMMRdb dataset.
VMMRdb structure: make_model_year folders containing images
Example: mercedes benz_slk280_2006
"""
...
def create_vmmrdb_annotations(vmmrdb_path="VMMRdb"):
    """Create annotations for VMMRdb dataset."""
    ...
    log.info(f"Created annotations for {total_images} images")
...
if __name__ == '__main__':
    ...
    create_vmmrdb_annotations(vmmrdb_path)
